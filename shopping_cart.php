...
<body>
    ...
    <div class="content-container">
        <div class="review">
            ...
            <div class="reviewcontent">
                <form id="reviewForm" action="php/shopping_cart.php" method="post">
                    <div class="input-box">
    ...
    <script src="js/shopping_cart.js" type="module"></script>
    <!-- JavaScript for Displaying Reviews -->
    <script>
        function fetchReviews() {
            fetch('php/shopping_cart.php') // Adjust URL as per your PHP script for fetching reviews
